# -*- coding: utf-8 -*-
"""Test cases for the circular array implementation of a queue.

This module tests the CircularArrayQueue, which is subclass of Queue. This
...
from circular_queue import CircularArrayQueue
import unittest
import exceptions


class CircularArrayQueueTest(unittest.TestCase):
    def setUp(self):
        self.queue = CircularArrayQueue(5)
    ...
    def test_circularity(self):
        """Test that underlying array is indeed circular."""
        self.queue.enqueue(1)
        self.queue.enqueue(2)
        self.queue.enqueue(4)
        self.queue.enqueue(-1)
